...
from apps.datasource.api import datasource, table_relation, permission
from apps.mcp import mcp
from apps.system.api import login, user, aimodel, workspace, assistant, appearance, custom_prompt
